struct Unit {
  ...
  static std::string description(){
    return
      "The unit argument specifies the io unit used internally by the\n"
      "Fortran routine and the filename to be read in, e.g. setting unit to\n"
      ...
      "\n"
      "Typically, unit values are restricted to an absolute value between 20\n"
      "and 99, inclusively.";
  }
