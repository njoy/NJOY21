...
SCENARIO( "value range" ){
  Argument< HEATR::Card1::Nendf > nendf; nendf.value = 22;
  {
    ...
    REQUIRE_THROWS( argument::extract< HEATR::Card1::Nin >( iss, nendf ) );
  }{
    iRecordStream<char> iss( std::istringstream("   -19") );
    REQUIRE_THROWS( argument::extract< HEATR::Card1::Nin >( iss, nendf ) );
  }{
    ...
    REQUIRE( argument::extract< HEATR::Card1::Nin >( iss, nendf ).value == 20 );
  }{
    iRecordStream<char> iss( std::istringstream("   -20") );
    REQUIRE( argument::extract< HEATR::Card1::Nin >( iss, nendf ).value == -20 );
  }{
    iRecordStream<char> iss( std::istringstream("   50") );
    REQUIRE( argument::extract< HEATR::Card1::Nin >( iss, nendf ).value == 50 );
  }{
    iRecordStream<char> iss( std::istringstream("   -50") );
    REQUIRE( argument::extract< HEATR::Card1::Nin >( iss, nendf ).value == -50 );
  }{
    iRecordStream<char> iss( std::istringstream("   99") );
    REQUIRE( argument::extract< HEATR::Card1::Nin >( iss, nendf ).value == 99 );
  }{
    iRecordStream<char> iss( std::istringstream("   -99") );
    REQUIRE( argument::extract< HEATR::Card1::Nin >( iss, nendf ).value == -99 );
  }{
