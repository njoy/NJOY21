...
SCENARIO( "ERRORR, Rest, Card13, Wght",
          "[ERRORR] [Rest] [Card13], [Wght]" ){
 ...
 "1.00925E+04 6.17490E-08 1.01859E+04 6.09190E-08 1.02802E+04 6.19874E-08\n" ));
      ...
      njoy::ENDFtk::TAB1 tab1 =
        argument::extract< ERRORR::Rest::Card13::Wght >( iss ).value;
 ...
 "1.00925E+04 6.17490E-08 1.01859E+04  6.09190E-08 1.02802E+04 6.19874E-08\n"));
        ...
        REQUIRE_THROWS( argument::extract< ERRORR::Rest::Card13::Wght >( iss ));
      }
    } // WHEN
